...
CHANNELS = {
    ...
    "marketing_sales": {
        "thread_env": "TOPIC_MARKETING_SALES",
        ...
        "keywords": [
            ...
            "community manager", "sales", "sales manager",
    ...
    "hr_recruiting": {
        "thread_env": "TOPIC_HR_RECRUITING",
        "name": "👥 HR & Recruiting",
        "keywords": [
    ...
    "finance_accounting": {
        "thread_env": "TOPIC_FINANCE_ACCOUNTING",
        ...
        "keywords": [
            ...
            "tax specialist", "auditor", "treasury",
        ],
    },
    "admin_operations": {
        "thread_env": "TOPIC_ADMIN_OPERATIONS",
        "name": "🗂️ Admin & Operations",
        "keywords": [
            "administrative", "admin assistant", "administrator",
            "office manager", "office administrator",
            "executive assistant", "personal assistant", "virtual assistant",
            "operations", "operations manager", "operations specialist",
            "logistics", "supply chain", "procurement", "inventory",
            "data entry",
        ],
    },
    "customer_support": {
        "thread_env": "TOPIC_CUSTOMER_SUPPORT",
        "name": "🎧 Customer Support",
        "keywords": [
            "customer support", "customer service", "customer care",
            "technical support", "support specialist", "support engineer",
            "help desk", "helpdesk", "client support",
        ],
    },
    "product_pm": {
        "thread_env": "TOPIC_PRODUCT_PM",
        "name": "📋 Product & Project Mgmt",
        "keywords": [
            "product manager", "associate product manager", "product owner",
            "project manager", "program manager", "scrum master",
            "agile coach", "delivery manager", "project coordinator",
        ],
    },
}
